                            ...
                            (o.lib = o.prototype =
                                {
                                    ...
                                    init: function (t) {
                                        return (
                                            ...
                                            (this.options.text =
                                                t.text || o.defaults.text),
                                            (this.options.node =
                                                t.node || o.defaults.node),
                                            ...
                                            (this.options.destination =
                                                t.destination ||
                                                o.defaults.destination),
                                            (this.options.newWindow =
                                                t.newWindow ||
                                                o.defaults.newWindow),
                                            (this.options.close =
                                                t.close || o.defaults.close),
                                            ...
                                            (this.options.avatar =
                                                t.avatar || o.defaults.avatar),
                                            (this.options.className =
                                                t.className ||
                                                o.defaults.className),
        ...
        (() => {
            ...
            document
                ...
                .addEventListener("click", function () {
                    o()({ text: "This is a toast", duration: 3e3 }).showToast();
                }),
                document
