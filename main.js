...
function createWindow () {
  ...
  mainWindow = new BrowserWindow({width: 1366, height: 768, autoHideMenuBar: false})

  // and load the index.html of the app.
  // mainWindow.loadURL('http://'+phpServer.hostname+':'+phpServer.port+'/');
  mainWindow.loadURL('http://127.0.0.1:8189/');
